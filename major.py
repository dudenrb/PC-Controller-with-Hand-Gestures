...
run_program = input("Do you want to run the Gesture Controller program? (y/n): ").strip().lower()
if run_program != 'y':
...
class Controller:
    ...
    # Retrieve the current brightness level as a float
        currentBrightnessLv = sbcontrol.get_brightness(display=0)[0] / 100.0
    # Adjust brightness based on the pinch level
